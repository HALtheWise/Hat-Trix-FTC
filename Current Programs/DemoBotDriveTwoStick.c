...
#pragma config(Sensor, S2,     lowerLight,     sensorLightActive)
...
#pragma config(Motor,  mtr_S1_C3_1,     LeftBack,      tmotorTetrix, openLoop)
#pragma config(Motor,  mtr_S1_C3_2,     RightBack,     tmotorTetrix, openLoop, reversed)
...
task main()
{
	...
	while(1)
	{
		...
		WaywardSon(joystick.joy2_TopHat == 0, joystick.joy2_TopHat == 4, auxButton(3));
...
bool armIsDown(){
	return SensorValue[lowerLight] < LIGHT_THRESH;
}
